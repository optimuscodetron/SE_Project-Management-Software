    ...
    <div className='bg-[#171e28] sm:w-[30vw] md:w-[25vw] w-[65vw] h-[80vh] overflow-y-scroll  text-white  z-10  right-0'>
       ...
       <div className='p-4'>
          ...
          <div className='flex items-center mt-4  '>
              <GrProjects/>
              <p className='ml-3'>{projectname}</p>
          </div>
        </div>
...

          {
            num==2?<div className='mt-[1.5rem] text-sm md:text-[16px] '>
                ...
                <button className=' w-full group text-left p-2 hover:bg-gray-700 flex justify-between' onClick={(e)=>handleFilterSidebarPriority(e,"urgent",1)} >
                  ...
                  <div className='text-gray-400 group flex w-[34%] justify-between'>{button2==1? <button className='text-white bg-gray-800 text-sm p-1' onClick={(e)=>handleClearFilters(e)}>Clear filters</button>:<p className='opacity-10 group-hover:opacity-100 mr-2 '>See issues</p>}  </div>
                 </button>
                ...
                <div className='text-gray-400 group flex w-[34%] justify-between'>{button2==2? <button className='text-white bg-gray-800 text-sm p-1' onClick={(e)=>handleClearFilters(e)}>Clear filters</button>:<p className='opacity-10 group-hover:opacity-100 mr-2 '>See issues</p>}</div>
                </button>
                ...
                <div className='text-gray-400 group flex w-[34%] justify-between'>{button2==3? <button className='text-white bg-gray-800 text-sm p-1' onClick={(e)=>handleClearFilters(e)}>Clear filters</button>:<p className='opacity-10 group-hover:opacity-100 mr-2 '>See issues</p>}</div>
                  </button>
                ...
                <div className='text-gray-400 group flex w-[34%] justify-between'>{button2==4? <button className='text-white bg-gray-800 text-sm p-1' onClick={(e)=>handleClearFilters(e)}>Clear filters</button>:<p className='opacity-10 group-hover:opacity-100 mr-2 '>See issues</p>}</div>
                </button>
