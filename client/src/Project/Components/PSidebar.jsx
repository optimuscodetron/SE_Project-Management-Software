        ...
        <div class="h-full px-2 py-4 overflow-y-auto bg-[#161c29]">
          <ul class="space-y-2 font-medium">
            <li onClick={props.openIssues}>
              <a
                href="#"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700  dark:hover:text-white group no-underline hover:no-underline"
              >
            ...
            <li>
              ...
              >
                <div className="flex items-center p-2 text-white text-decoration-none  rounded-lg hover:bg-gray-7 00 group">
                  ...
                  <span class="flex row ms-3  whitespace-nowrap text-decoration-none">
                    Settings
                  </span>
                </div>
              </NavLink>
