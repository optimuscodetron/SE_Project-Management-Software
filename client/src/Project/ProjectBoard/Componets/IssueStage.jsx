...
export default function IssueStage({ stageName, issues, onMoveIssue }) {
    return (
        <div className="mb-8 h-full overflow-y-auto relative  p-1 rounded-lg">
            <h2 className="text-2xl text-white font-normal mb-4 bg-[#074c5b] tracking-wider sticky top-0 z-10 py-0 text-center font-sans rounded drop-shadow-md tracking-normal " style={style}>
                {stageName}
            </h2>
