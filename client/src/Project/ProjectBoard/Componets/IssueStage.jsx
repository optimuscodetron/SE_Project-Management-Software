...
export default function IssueStage({ stageName, issues, onMoveIssue }) {
    return (
        <div className="mb-8 h-full overflow-y-auto p-1 rounded-lg">
            <h2 className="text-2xl  text-white font-normal mb-4 bg-[#074c5b] tracking-wider    py-0 text-center font-sans rounded drop-shadow-md  " style={style}>
                {stageName}
            </h2>
