...
function Invite() {
  ...
  const copyLink = () => {
    ...
    const randomLink = `https://example.com/invite/${Math.random()
      .toString(36)
      .substring(7)}`;
      ...
      <div className="flex justify-center items-center h-screen bg-white">
        <div className="bg-gray-300 rounded-lg p-8 shadow-md">
          <h2 className="text-2xl font-bold mb-4">
            Invite Co-workers to your workspace
          </h2>
          <div className="flex items-center mb-4">
            ...
            <button
              onClick={copyLink}
              className="bg-blue-700 text-white px-4 py-2 rounded-r-lg focus:outline-none hover:bg-blue-600"
            >
              Copy Link
            </button>
          </div>
          {showForm ? (
            <form onSubmit={sendInvite}>
              ...
              <button
                type="submit"
                className="block w-full bg-blue-700 text-white py-2 px-4 rounded-lg focus:outline-none mb-4 hover:bg-blue-600"
              >
                Send Invite
              </button>
            </form>
