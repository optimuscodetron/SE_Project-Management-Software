...
const General = () => {
  ...
  return (
    <div
      className="bg-gray-800 overflow-auto h-screen w-screen flex flex-row "
      style={{
        scrollbarWidth: "thin",
    ...
    >
      ...
      <div
        className="w-[45vw] md:w-[41vw] ml-[36vw] h-full overflow-auto mt-10  bg-gray-900 text-white p-3 "
        style={{
          scrollbarWidth: "thin",
          scrollbarColor: "rgba(0,0,0,0) rgba(0,0,0,0)",
        }}
      >
        ...
        <div className="rounded-lg mt-3 mb-2">
          ...
          {upload && (
            <button className="hover:cursor-pointer absolute top-[33vh] left-[37.5vw] text-white">
              upload
            </button>
          )}
        </div>
        ...
        <div className="border-gray-500 border-b-[1px]">
          ...
          <input
            value={workspaceName}
            className="bg-[rgb(15,19,29)] w-[35vw] md:w-[17vw] border-[1px] px-2 py-[2px]  border-gray-600 rounded-sm"
