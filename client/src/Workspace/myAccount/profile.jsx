...
const profile = () => {
  return (
    <div className="flex flex-row w-screen">
      ...
      <div className="bg-gray-800 w-full min-h-screen flex flex-column items-center  justify-center">
        <div className="bg-black p-8 rounded-lg shadow-md w-[50%] text-white">
          <h1 className="text-3xl font-bold mb-2">Profile</h1>
          <p className="text-white mb-6">Manage your TrakerX profile</p>
          ...
          <div className="mb-4">
            ...
            <p className="text-white mb-2">user@example.com</p>
          </div>
